      ...
      <div className="tabs tabs--small tabs--border">
        ...
        <div className="tabs__content">
          {this.state.selected === 0
            ? <Text text={content.title} placeholder="Skriv tittel" editMode={this.context.editMode} activeEditMode={activeEditMode} editorType="simple" scope={`${scope}.title`} />
            : <Text text={content.url} placeholder="Legg til URL" editMode={this.context.editMode} activeEditMode={activeEditMode} editorType="simple" scope={`${scope}.url`} />}
        </div>
      </div>
    );
  }
