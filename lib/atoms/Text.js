...
var getEditorType = function getEditorType(editorType, text, placeholder, scope, selfSaving) {
  switch (editorType) {
    case 'simple':
      return _react2.default.createElement(_nocmsEditor.Simple, { text: text, placeholder: placeholder, scope: scope });
    case 'simpleWithLink':
      return _react2.default.createElement(_nocmsEditor.LinkEditor, { text: text, placeholder: placeholder, selfSaving: selfSaving, scope: scope });
    default:
      return _react2.default.createElement(_nocmsEditor.Simple, { text: text, placeholder: placeholder, scope: scope });
  }
};
...
Text.propTypes = {
  ...
  selfSaving: _propTypes2.default.bool
};
